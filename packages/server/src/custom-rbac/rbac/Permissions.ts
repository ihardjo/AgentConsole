 ...
 *
 * CLEAN ROOM IMPLEMENTATION: This file defines permissions independently
 * without reference to any FlowiseAI Enterprise code.
 */
...
export class Permissions {
    ...
    constructor() {
        ...
        adminCategory.addPermission(new Permission('platformConfiguration:manage', 'Manage Platform Configuration'))
