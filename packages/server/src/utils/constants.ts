export const WHITELIST_URLS = [
    ...
    '/api/v1/account-management/register',
    '/api/v1/account-management/login',
    '/api/v1/account-management/logout',
    '/api/v1/account-management/verify',
    '/api/v1/account-management/resend-verification',
    '/api/v1/account-management/forgot-password',
    '/api/v1/account-management/reset-password',
    '/api/v1/account-management/basic-auth',
    ...
    '/api/v1/platform-configuration/favicon',
    '/api/v1/platform-configuration/logo',
    '/api/v1/platform-configuration/app-name',
    // AzureSSO URIs
    '/api/v1/azure/login',
    '/api/v1/azure/logout',
