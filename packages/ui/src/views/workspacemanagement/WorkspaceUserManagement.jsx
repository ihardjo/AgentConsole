...
import InviteUsersDialog from '@/ui-component/dialog/InviteUserManagementDialog'
...
const WorkspaceUserManagement = () => {
    ...
    const getWorkspaceByIdApi = useApi(workspaceManagementApi.getWorkspaceById)
    ...
    const unlinkUser = async () => {
        ...
        if (isConfirmed) {
            try {
                const deletePromises = usersSelected.map((user) =>
                    userManagementApi.deleteWorkspaceUser(workspaceId, user.userId, currentUser.activeOrganizationId)
                )
